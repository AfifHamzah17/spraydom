...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-4 left-0 right-0 z-50 flex items-center justify-center pointer-events-auto">
      <div className="max-w-5xl w-full mx-4 bg-white/95 backdrop-blur-md rounded-2xl shadow-lg px-4 py-2 flex items-center justify-between">
        ...
        <NavLink to="/sleeptube" className={({ isActive }) => `flex-1 text-center p-2 ${isActive ? 'text-primary' : 'text-gray-600'}`}>
          <div className="flex flex-col items-center">
        ...
        <NavLink to="/dreamlog" className={({ isActive }) => `flex-1 text-center p-2 ${isActive ? 'text-primary' : 'text-gray-600'}`}>
          <div className="flex flex-col items-center">
