        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
            <div className="flex items-center mb-4">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mr-3">
                <img src="/image/hijab.png" alt="A" className="h-16 w-16" />
              </div>
              <div>
          ...
          <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
           ...
           <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
            ...
            <p className="text-gray-300 justify-center">“Simple, effective, and smells amazing. This website has become part of my nightly routine.”</p>
          </div>
        </div>
      </div>
    </div>
